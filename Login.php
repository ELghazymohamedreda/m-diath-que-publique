...
if(isset($_POST["submit"])){
  ...
  $mtp = $_POST["mtp"];
  $result = mysqli_query($con, "SELECT * FROM Adherent WHERE adresse_email = '$email' AND mtp ='$mtp'");
  $row = mysqli_fetch_assoc($result);

///////////////////////condition de confirmation et verifier le mot pass

  if(mysqli_num_rows($result) > 0){
    if($password == $row['password']  && $email == $row['adresse_email']) {
      $_SESSION["login"] = true;
                    ...
                    <div class="signin-form">
                        ...
                        <form method="POST" class="register-form" id="login-form">
                            <div class="form-group">
                                ...
                                <input type="text" name="adresse_email" id="your_name" placeholder="Your Email"/>
                            </div>
                            <div class="form-group">
